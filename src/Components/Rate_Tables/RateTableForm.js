...
class RateTableForm extends React.Component {
  ...
  return (
    <form className='ui form error' onSubmit={this.props.handleSubmit(this.onSubmit)}>
      ...
      <Field name='start' component={this.renderInput} label='Enter Rate Effective Start Date (DD-MM-YYYY)'/>
      <Field name='end' component={this.renderInput} label='Enter Rate Effective End Date (DD-MM-YYYY)'/>
